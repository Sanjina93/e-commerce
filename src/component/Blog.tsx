    ...
    return (
        ...
        <div className="sm:w-[1257px] md:w-[1355px] lg:w-[1455px] xl:w-full my-32">
            {features.map((feature) => (
                <div key={feature.id}>
                    <h2 className="text-2xl justify-self-center font-bold">{feature.h4}</h2>

                    <div className="flex">
                        <div className="grid grid-cols-3  m-5">
                            <img src={feature.image} alt="" className=" rounded-lg shadow-md w-[495px] h-[285px]  object-cover" />
                            <div>
                                <p className="text-lg w-[795px] ml-10 text-gray-500">{feature.description}</p>
                                <div className="flex gap-4 ml-10 text-gray-500 ">
                                    <img src={feature.image1} alt="" className='w-[32px] h-[20px] object-cover  text-[#23A6F0]' />
                                    <p> {feature.p4}</p>
                                    <img src={feature.image2} alt="" className='w-[20px] h-[20px]  object-cover' />
                                    <p>{feature.p5}</p>
                                </div>
                            </div>
                        </div>
