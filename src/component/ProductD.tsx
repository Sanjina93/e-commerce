        ...
        <div key={product.id}>
          ...
          <div className="flex my-4">
            ...
            <div>
              ...
              <div className={`top-0 right-0 fixed w-96 h-full shadow-md bg-white transition-transform duration-300 transform p-4 overflow-y-auto ${prodContext?.isOpen ? "translate-x-0" : "translate-x-full"}`}>
